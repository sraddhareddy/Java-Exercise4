# Java-Exercise4
In Java folder,it contains all .java classes of exercise4 In test folder,it contains all test.java classes of exercise3.these classes contain testcases to check respective .java files
